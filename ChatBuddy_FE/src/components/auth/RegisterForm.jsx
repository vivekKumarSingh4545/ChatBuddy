...
export default function RegisterForm() {
    ...
    return (
      <div className="min-h-screen w-full flex items-center justify-center overflow-hidden relative bg-dark_bg_1">
        ...
        {/* Container */}
        <div className="w-full max-w-md space-y-6 p-8 dark:bg-dark_bg_2/40 backdrop-blur-xl border border-dark_border_1 shadow-[0_8px_32px_0_rgba(99,102,241,0.08)] rounded-2xl z-10 my-8">
          {/*Heading*/}
